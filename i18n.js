 ...
 * ============================================================
 * 使用方式：
 *   HTML 节点加 data-i18n="key"  → 自动替换 textContent
 *   HTML 节点加 data-i18n-placeholder="key" → 替换 placeholder
 *   JS 中调用 I18n.t('key') → 返回翻译文本
 *   I18n.setLang('en') / I18n.setLang('zh') → 切换语言
 * ============================================================
 */
...
const I18n = (function () {
    ...
    const translations = {
        ...
        hero_role_prefix: { zh: '创意开发者 & 设计师，融合', en: 'Creative Developer & Designer blending ' },
        hero_role_code:   { zh: '代码', en: 'code' },
        hero_role_design: { zh: '设计', en: 'design' },
        hero_role_and:    { zh: '、', en: ', ' },
        hero_role_motion: { zh: '与动效', en: 'motion' },
        hero_role_suffix: { zh: '，打造数字体验。', en: ' into digital experiences.' },
        ...
        work_title_1:    { zh: '最近的', en: 'Recent ' },
        work_title_2:    { zh: '项目', en: 'projects' },
        work_title_3:    { zh: '。', en: '.' },
        ...
        contact_title_1:  { zh: '一起来做', en: "Let's make " },
        contact_title_2:  { zh: '点了不起的事', en: 'something great' },
        contact_title_3:  { zh: '。', en: '.' },
    ...
    function applyAll() {
        ...
        // 带 HTML 结构的翻译（翻译内容在本 JS 内硬编码，无 XSS 风险）
    ...
    function init() {
        ...
        if (btnMobile) {
            btnMobile.addEventListener('click', (e) => {
                ...
                toggle();
                // 切换后同步文本
                btnMobile.textContent = currentLang === 'zh' ? 'EN / 中' : '中 / EN';
            });
        }
